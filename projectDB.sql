...
insert into Taxonomy values('T0039','Hippopotamus amphibius','Herbivore diet',' {short description of image}The Hippopotamus is an extremely fat animal, with a round body, short, stocky legs, and a large head. Female Hippos are usually slightly smaller than the male Hippos. The male Hippo can grow up to twelve feet long and five feet high, and can weigh up to 8,000 pounds. The female Hippo, however, is slightly smaller. The Hippo body is a brownish-gray color on top, and paler on the underside, with pink areas on the face.');
